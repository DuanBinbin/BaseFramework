...
namespace CoreFramework.Editor {
    ...
    public class ModelTypeWidgetNode {
        ...
        public void Render() {
            ...
            foreach (ModelTypeWidgetNode node in nodes) {
                Vector2 aggregationCountPosition = node.TypeWidget.Position - .70f * ModelTypeWidget.Width * Vector2.right + CoreFrameworkMonitorWindow.WindowOffset;
                CoreFrameworkEditorStyles.SetLabelStyle(CoreFrameworkEditorStyles.LabelStyle.AggregationCountType);
