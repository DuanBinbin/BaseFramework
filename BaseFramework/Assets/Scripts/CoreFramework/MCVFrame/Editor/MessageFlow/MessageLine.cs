...
namespace CoreFramework.Editor {
    ...
    public class MessageLine {
        ...
        public void RenderLine() {
            lineColor = CoreFrameworkEditorStyles.MessageLineColor;
        ...
        public void RenderMessages(bool renderNames) {
            foreach (LineMessage lineMessage in lineMessages) {
                ...
                lineMessage.Render(CoreFrameworkMonitorWindow.WindowOffset + GetPositionOnLine(easedPositionFactor), renderNames);
            }
        }
