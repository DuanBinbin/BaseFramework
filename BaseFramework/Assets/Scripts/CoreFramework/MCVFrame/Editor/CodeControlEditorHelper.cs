/// <copyright file="CoreFrameworkEditorHelper.cs">Copyright (c) 2015 All Rights Reserved</copyright>
...
namespace CoreFramework.Editor {
    ...
    public static class CoreFrameworkEditorHelper {
        ...
        public static List<Type> GetAllModelTypes() {
            ...
            foreach (var asm in AppDomain.CurrentDomain.GetAssemblies()) {
                foreach (Type type in asm.GetTypes()) {
                    if (CoreFrameworkEditorHelper.IsDerived(type, typeof(Model)) && type != typeof(ModelProxy)) {
                        types.Add(type);
                    }
                }
            }
