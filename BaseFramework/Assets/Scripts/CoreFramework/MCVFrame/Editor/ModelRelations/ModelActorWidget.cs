...
namespace CoreFramework.Editor {
    ...
    public class ModelActorWidget : ButtonWidget, IComparable<ModelActorWidget> {
        ...
        public ModelActorWidget(Type modelType, ModelRelationsWidget modelRelationsWidget) : base() {
            ...
            TypeName = CoreFrameworkEditorHelper.GetActualTypeName(modelType);
        }

        public override void Update() {
            age += CoreFrameworkMonitorWindow.DeltaTime;
            base.Update();
        }
        ...
        public bool IsActualType(Type type) {
            return CoreFrameworkEditorHelper.GetActualTypeName(type) == TypeName;
        }
        ...
        protected override void ShowContextMenu() {
            ...
            menu.AddItem(new GUIContent("Open " + TypeName + ".cs"), false, delegate() {
                CoreFrameworkEditorHelper.OpenCodeOfType(ModelType);
            });
